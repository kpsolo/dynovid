if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(t) { "use strict"; var e = t.fn.jquery.split(" ")[0].split("."); if (e[0] < 2 && e[1] < 9 || 1 == e[0] && 9 == e[1] && e[2] < 1 || e[0] > 3) throw new Error("Bootstrap's JavaScript requires jQuery version 1.9.1 or higher, but lower than version 4") }(jQuery), + function(t) {
    ...
    var s = t.fn.collapse;
    t.fn.collapse = n, t.fn.collapse.Constructor = i, t.fn.collapse.noConflict = function() { return t.fn.collapse = s, this }, t(document).on("click.bs.collapse.data-api", '[data-toggle="collapse"]', function(i) {
        var s = t(this);
    ...
    t.fn.emulateTransitionEnd = function(e) {
        ...
        var s = function() { n || t(i).trigger(t.support.transition.end) };
...
$('.events ul').each(function() {
    ...
    $.each($items, function(i) {
        ...
        if (currentDate.getTime() - eventDate.getTime() < 0) {
            $($items[i]).addClass('e-next');
            $($($links[i]).attr('href') + " div.button").show();
            iCurrent = i + 1;
        }
    });
